...
interface ABClientAPI {
   ...
   */
  function pendingUpdateRejected(context: ABClientAPIPendingChangeContext)
   ...
   * @param context the context information for the change
   */
  function pendingCreateRejected(context: ABClientAPIPendingChangeContext)
   ...
   * @param context the context information for the change
   */
  function pendingCreateApproved(context: ABClientAPIPendingChangeContext)
   ...
   */
  function pendingUpdateApproved(context: ABClientAPIPendingChangeContext, abuidContainer: ABClientAPIAddressBookUIDContainer)
