...
uses wsi.remote.gw.webservice.bc.bc1000.beanmodel.XmlBackedInstance
uses wsi.remote.gw.webservice.bc.bc1000.contactapi.ContactAPI
uses wsi.remote.gw.webservice.bc.bc1000.contactapi.anonymous.elements.ABClientAPIAddressBookUIDContainer_AddressBookUIDTuples
uses wsi.remote.gw.webservice.bc.bc1000.contactapi.anonymous.elements.ABClientAPIAddressBookUIDContainer_AddressBookUIDTuples_Entry
uses wsi.remote.gw.webservice.bc.bc1000.contactapi.faults.BadIdentifierException
uses wsi.remote.gw.webservice.bc.bc1000.contactapi.faults.IllegalArgumentException
uses wsi.remote.gw.webservice.bc.bc1000.contactapi.faults.IllegalStateException
uses wsi.remote.gw.webservice.bc.bc1000.contactapi.faults.RequiredFieldException
uses wsi.remote.gw.webservice.bc.bc1000.contactapi.types.complex.ABClientAPIAddressBookUIDContainer
uses wsi.remote.gw.webservice.bc.bc1000.contactapi.types.complex.ABClientAPIPendingChangeContext
uses entity.ABContact

@Export
class BCBillingSystemPlugin extends ClientSystemPlugin1000 {
  ...
  protected function createRemoteABClientAPIPendingChangeContext(contextXml : String) : ABClientAPIPendingChangeContext {
    ...
    var clientContext = new ABClientAPIPendingChangeContext() {
      ...
      :Resolution = wsi.remote.gw.webservice.bc.bc1000.contactapi.enums.ContactChangeResolution.forGosuValue(context.Resolution.Code),
