...
uses wsi.remote.gw.webservice.cc.cc900.beanmodel.XmlBackedInstance
uses wsi.remote.gw.webservice.cc.cc900.contactapi.ContactAPI
uses wsi.remote.gw.webservice.cc.cc900.contactapi.anonymous.elements.ABClientAPIAddressBookUIDContainer_AddressBookUIDTuples
uses wsi.remote.gw.webservice.cc.cc900.contactapi.anonymous.elements.ABClientAPIAddressBookUIDContainer_AddressBookUIDTuples_Entry
uses wsi.remote.gw.webservice.cc.cc900.contactapi.types.complex.ABClientAPIAddressBookUIDContainer
uses wsi.remote.gw.webservice.cc.cc900.contactapi.types.complex.ABClientAPIPendingChangeContext

uses java.lang.Exception


@Export
class CCClaimSystemPlugin extends ClientSystemPlugin900 {
  ...
  override protected function isNonRetryableSOAPException(e : Exception) : boolean {
    return  e typeis wsi.remote.gw.webservice.cc.cc900.contactapi.faults.BadIdentifierException or
            e typeis wsi.remote.gw.webservice.cc.cc900.contactapi.faults.RequiredFieldException or
            e typeis wsi.remote.gw.webservice.cc.cc900.contactapi.faults.SOAPSenderException
  }
  ...
  protected function createRemoteABClientAPIPendingChangeContext(contextXml : String) : ABClientAPIPendingChangeContext {
    ...
    var clientContext = new ABClientAPIPendingChangeContext() {
      ...
      :Resolution = wsi.remote.gw.webservice.cc.cc900.contactapi.enums.ContactChangeResolution.forGosuValue(context.Resolution.Code),
