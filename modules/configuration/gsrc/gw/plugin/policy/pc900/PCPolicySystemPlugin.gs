package gw.plugin.policy.pc900
...
uses wsi.remote.gw.webservice.pc.pc900.beanmodel.XmlBackedInstance
uses wsi.remote.gw.webservice.pc.pc900.contactapi.ContactAPI
uses wsi.remote.gw.webservice.pc.pc900.contactapi.anonymous.elements.ABClientAPIAddressBookUIDContainer_AddressBookUIDTuples
uses wsi.remote.gw.webservice.pc.pc900.contactapi.anonymous.elements.ABClientAPIAddressBookUIDContainer_AddressBookUIDTuples_Entry
uses wsi.remote.gw.webservice.pc.pc900.contactapi.faults.BadIdentifierException
uses wsi.remote.gw.webservice.pc.pc900.contactapi.faults.IllegalArgumentException
uses wsi.remote.gw.webservice.pc.pc900.contactapi.faults.RequiredFieldException
uses wsi.remote.gw.webservice.pc.pc900.contactapi.faults.SOAPException
uses wsi.remote.gw.webservice.pc.pc900.contactapi.types.complex.ABClientAPIAddressBookUIDContainer
uses wsi.remote.gw.webservice.pc.pc900.contactapi.types.complex.ABClientAPIPendingChangeContext

uses java.lang.Exception


@Export
class PCPolicySystemPlugin extends ClientSystemPlugin900 {
  ...
  protected function createRemoteABClientAPIPendingChangeContext(contextXml : String) : ABClientAPIPendingChangeContext {
    ...
    var clientContext = new ABClientAPIPendingChangeContext() {
      ...
      :Resolution = wsi.remote.gw.webservice.pc.pc900.contactapi.enums.ContactChangeResolution.forGosuValue(context.Resolution.Code),
